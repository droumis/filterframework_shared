function out = dfa_riptrigspectrogram(index, excludeperiods, eeg, events, varargin)
...
out.eventStartTimes = eventtimes;
out.LFPstarttime = starttime;
out.samprate = params.Fs;
out.S = S;
out.t = t - win(1);
out.f = f;

disp(sprintf('%s', num2str(index)));
if appendindex
	out.index = index;
end
