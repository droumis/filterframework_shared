...
case 'vca1ripplescons' 
 ...
 if runscript
     ...
     for animal = animals_torun
         ...
         f = setfilterfunction(f, 'dfa_geteventtrigspiking', {'spikes',eventconsname,'pos','task','sleep','cellinfo'},animaldir,animalprefix,'TF',TF,'window',window,'binsize',binsize,'frbinsize',frbinsize,'minthresh',minthresh,'maxvelocity',maxvelocity,'minvelocity', minvelocity,'consensus_numtets',consensus_numtets,'welldist',welldist);
