...
%             DIOin{j} = DIO{day}{epoch}{filled_indios(j)};
     ...
     % Input wells
        ...
        % Assigns as correct any outbound home-adjacent visits where prev prev was anything but the current well 
        % (accounts for prev prev inbound errors to nonrewarded wells) 
