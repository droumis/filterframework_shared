function [out] = getconstimes(animaldir,animalprefix, epochs, eventconsname, tetfilter, varargin)
% out = getconstimes(animaldir,animalprefix, epochs, eventconsname, varargin)
